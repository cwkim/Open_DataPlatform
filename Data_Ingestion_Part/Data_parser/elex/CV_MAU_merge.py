...
class MongoDefault:
    ...
    def Merge_Data(self):
        ...
        ELEX_col = self.mo_db.get_collection(ELEX_MAU_Col)
        print("ELEX 컬렉션:", ELEX_col)

        TRIPHOS_col = self.mo_db.get_collection(TRIPHOS_DAU_Col)
        ...
        for ELEX_dict in ELEX_Result:
            ...
            if ELEX_dict["datetime"].year == 2019 and ELEX_dict["datetime"].month >= 6:
                ...
                print(TRIPHOS_data["datetime"])

                # if ELEX_dict["datetime"].month == 7:
                #     exit(1)

                print("ELEX : ", ELEX_dict["accumulate_data_count"])
                print("TRIPHOS : ", TRIPHOS_data["accumulate_data_count"])
                print(
                    "merge",
                    ELEX_dict["accumulate_data_count"]
                    + TRIPHOS_data["accumulate_data_count"],
                )

                input_data_dict_1 = {
                    "datetime": ELEX_dict["datetime"],
                    "count_driving_car": ELEX_dict["count_driving_car"]
                    + TRIPHOS_data["count_driving_car"],
                    "count_store_car": ELEX_dict["count_store_car"]
                    + TRIPHOS_data["count_store_car"],
                    "data_count": ELEX_dict["data_count"] + TRIPHOS_data["data_count"],
                    "accumulate_data_count": ELEX_dict["accumulate_data_count"]
                    + TRIPHOS_data["accumulate_data_count"],
                    "data_size": ELEX_dict["data_size"] + TRIPHOS_data["data_size"],
                    "accumulate_data_size": ELEX_dict["accumulate_data_size"]
                    + TRIPHOS_data["accumulate_data_size"],
                    "accumulate_distance": ELEX_dict["accumulate_distance"]
                    + TRIPHOS_data["accumulate_distance"] / 1000,
                }
                ...
                input_data_dict_1 = {
                    ...
                    "count_driving_car": ELEX_dict["count_driving_car"],
                    "count_store_car": ELEX_dict["count_store_car"],
                    "data_count": ELEX_dict["data_count"],
                    "accumulate_data_count": ELEX_dict["accumulate_data_count"],
                    "data_size": ELEX_dict["data_size"],
                    "accumulate_data_size": ELEX_dict["accumulate_data_size"],
                    "accumulate_distance": ELEX_dict["accumulate_distance"],
                }
                ...
                input_data_dict_1 = {
                    "datetime": ELEX_dict["datetime"],
                    "count_driving_car": ELEX_dict["count_driving_car"] + 2800,
                    "count_store_car": ELEX_dict["count_store_car"] + 4190,
                    "data_count": ELEX_dict["data_count"] + TRIPHOS_data["data_count"],
                    "accumulate_data_count": ELEX_dict["accumulate_data_count"]
                    + TRIPHOS_data["accumulate_data_count"],
                    "data_size": ELEX_dict["data_size"] + TRIPHOS_data["data_size"],
            ...
            self.save_to_mongo("MAU_merge", input_data_dict_1)
