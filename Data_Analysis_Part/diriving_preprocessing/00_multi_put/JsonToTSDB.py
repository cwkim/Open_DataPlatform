...
def brush_argparse():
    ...
    parser.add_argument("-cn", help="DB에 put 수행할 서브프로세스 개수")
...
if __name__ =='__main__':
    ...
    if inputdir == 'def':
        #root_path = '../CSVJSON/output/resultData'
        root_path = './inputfile'
    else:
        root_path = inputdir
    cn = int(_args_.cn)
    ...
    workers = pcs.Workers(cn, opentsdb_url)
    works_basket = workers.start_work()
    ...
    for file_path in file_list:
        ...
        printProgressBar(loop_count, tot_file_len)
        ...
        loop_count += 1
    printProgressBar(tot_file_len, tot_file_len)
    print("\nwork basker에 모든 data 전송 완료")
