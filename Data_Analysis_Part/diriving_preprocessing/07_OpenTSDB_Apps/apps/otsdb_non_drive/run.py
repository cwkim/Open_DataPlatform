...
def savefile(buf):
    f = open('sav_id_list.py', 'w')    # 경로설정 / 덮어쓰기
...
if __name__ == "__main__":
    ...
    if carid == 'none':  meta['carid'] = '*'
    elif carid == 'saved_id':
        sys.path.append("../otsdb_get_ids")
        import save_id_list
        carid_list = save_id_list.car_id_list
        carid_str = 0
        for i in range(len(carid_list)):
            if i == 0:
                carid_str = carid_list[i]
            else:
                carid_str =  carid_str+'|'+str(carid_list[i])

        #print(carid_str)
        meta['carid'] = carid_list
    elif carid == 'hanuri_10' :
        meta['carid'] = '1224847025|1229054547|1229088139|1224846449|1224847697|1224847046|1224847021|1224847678|1224069395|1224844410'
