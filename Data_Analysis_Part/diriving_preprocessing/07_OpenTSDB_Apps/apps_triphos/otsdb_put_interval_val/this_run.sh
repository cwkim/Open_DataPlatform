...
port_in=54242
# [3]
metric_in='Triphos.202003.stop_startend_by_DPS'
...
port_out=54242
# [6]
metric_out='Triphos.202003.stop_interval_by_DPS'
# [7]
...
content='DRIVE_START|DRIVE_END|STOP_START|STOP_END|PARKING_START|PARKONG_END'
# [12]
agg='none'
# [13] # id is carid
#id='14'
