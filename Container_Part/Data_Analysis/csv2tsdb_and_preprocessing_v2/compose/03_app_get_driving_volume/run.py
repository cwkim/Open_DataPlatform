...
if __name__ == "__main__":
    ...
    if carid == 'none':
        ...
        sys.path.append("../01_otsdb_get_ids")
        import save_id_list
    ...
    if meta['carid']=='*':
        ...
        temp_meta['in_metric']=meta['in_metric'].split('|')[-1]
        car_id_meta = qd.query_to_getids_v2(temp_meta)
        car_id_list = car_id_meta[0]
        meta['carid'] = '|'.join(car_id_list)
        print("get total id : %s\n" %(meta['carid']))
