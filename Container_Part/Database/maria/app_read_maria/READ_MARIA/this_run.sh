...
tablename="table2"
# [7] number of rows to query from table
count=10
...
echo "number of rows to query from table : "$count
echo "====================================================<<"
...
# 인자값 7개   
#                   [1]     [2]         [3]         [4]     [5]             [6]                    [7]
python READ_MARIA.py -ip $ip -port $port -user $user -pw $pw -dbname $dbname -tablename $tablename -count $count
